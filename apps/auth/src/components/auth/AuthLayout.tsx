	...
	return (
		<main className='min-h-screen bg-background'>
			<div className='grid min-h-screen lg:grid-cols-[1.1fr_0.9fr]'>
				<section className='relative hidden min-h-screen overflow-hidden bg-[#070a0a] p-10 text-white lg:flex lg:flex-col'>
					...
					<div className='relative z-10 my-auto max-w-2xl'>
						<div className='mb-6 inline-flex items-center rounded-full border border-emerald-400/15 bg-emerald-400/[0.06] px-3 py-1.5 text-xs text-emerald-300 backdrop-blur-xl'>
						...
						<p className='mt-6 max-w-lg text-base leading-7 text-zinc-400'>
							Manage your money, track your spending and move funds with a
							banking experience designed around you.
						</p>
							...
							<div className='absolute left-1/2 top-1/2 w-full max-w-sm -translate-x-1/2 -translate-y-1/2 rounded-3xl border border-white/10 bg-white/[0.055] p-6 shadow-2xl shadow-black/50 backdrop-blur-2xl'>
								...
								<div className='relative'>
									...
									<div className='mt-7 flex h-24 items-end gap-1'>
										{[35, 42, 32, 55, 47, 62, 51, 74, 68, 84, 72, 96].map(
											(height, index) => (
												<div
													key={index}
